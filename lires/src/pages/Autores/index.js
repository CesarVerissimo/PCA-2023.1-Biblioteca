            ...
            <div className='card-autor'>
                <Link className='link-card-autor' to="#">
                    ...
                    <div>
                        ...
                        src="https://picsum.photos/180/230?random=2"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=21"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=12"
                        />
                    </div>
                </Link>
            </div>
            ...
            <div className='card-autor'>
                <Link className='link-card-autor' to="#">
                    ...
                    <div>
                        ...
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=20"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=13"
                        />
                    </div>
                </Link>
            </div>
            ...
            <div className='card-autor'>
                <Link className='link-card-autor' to="#">
                    ...
                    <div>
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=7"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=8"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=9"
                        />
                    </div>
                </Link>
            </div>
            ...
            <div className='card-autor'>
                <Link className='link-card-autor' to="#">
                    ...
                    <div>
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=29"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=1"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=28"
                        />
                    </div>
                </Link>
            </div>
            ...
            <div className='card-autor'>
                <Link className='link-card-autor' to="#">
                    ...
                    <div>
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=11"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=10"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=33"
                        />
                    </div>
                </Link>
            </div>
            ...
            <div className='card-autor'>
                <Link className='link-card-autor' to="#">
                    ...
                    <div>
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=16"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=17"
                        />
                        <img
                        className='img-card-livro'
                        src="https://picsum.photos/180/230?random=18"
                        />
                    </div>
                </Link>
            </div>
